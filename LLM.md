...
│  Text           │  (0.5B)         │  ~150ms                       │
├─────────────────┼─────────────────┼─────────────────────────────┤
│  Cloned Audio   │  MuseTalk        │  Lip Synchronization         │
│  + Video        │                 │  ~200ms                       │
├─────────────────┴─────────────────┴─────────────────────────────┤
...
│   ├── lip_sync/
│   │   ├── __init__.py
│   │   ├── musetalk.py        # MuseTalk lip synchronization
│   │   └── musetalk.py  # MuseTalk neural network architecture
│   ├── streaming/
│   │   ├── __init__.py
...
### 4. MuseTalkLipSync (lip_sync/musetalk.py)
...
- `src/zen_translator/lip_sync/musetalk.py` - MuseTalk (line 21: MuseTalkLipSync)
...
6. The MuseTalk model requires `musetalk.py` for architecture definition
