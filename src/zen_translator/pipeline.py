...
Combines Qwen3-Omni, CosyVoice, and MuseTalk for end-to-end
...
from .lip_sync import MuseTalkLipSync
...
class TranslationPipeline:
    ...
    3. Cloned audio + Video → MuseTalk (lip synchronization)
    ...
    def __init__(self, config: TranslatorConfig | None = None):
        ...
        self.lip_sync = MuseTalkLipSync(self.config)
    ...
    async def translate_video(
        ...
        4. Synchronize lips with MuseTalk
        ...
        if self.config.enable_lip_sync:
            logger.info("Synchronizing lips (MuseTalk)...")
